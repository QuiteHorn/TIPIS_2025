...
async def check_with_ai(content: str) -> str:
    ...
    prompt = f"""
Проанализируй эту лабораторную работу студента и дай развернутую оценку. Ты - кандидат технических наук, глубоко разбирающийся в дисциплинах инженерной области, программировании, физике.

КРИТЕРИИ ОЦЕНКИ (100 баллов максимум):
Составь на своё профессиональное усмотрение, главное чтобы в пределах разумного.

СОДЕРЖИМОЕ РАБОТЫ:
{content}

Дай конструктивную оценку с описанием работы и сделанных выводов, дай возможные рекомендации для улучшения и поставь итоговую оценку по 100-балльной шкале
